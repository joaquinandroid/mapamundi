...
import com.example.mapamundi.modelo.PantallaAsiaPPviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaAsiaPP(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar24() },
        bottomBar = { PersonalizarBottomBar24() },
        content = { padding ->
            ContenidoScaffold24(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold24(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaAsiaPPviewModel = viewModel(),
    contexto: Context
