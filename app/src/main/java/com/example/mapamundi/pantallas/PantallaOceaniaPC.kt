...
import com.example.mapamundi.modelo.PantallaOceaniaPCviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaOceaniaPC(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar16() },
        bottomBar = { PersonalizarBottomBar16() },
        content = { padding ->
            ContenidoScaffold16(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold16(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaOceaniaPCviewModel = viewModel(),
    contexto: Context
