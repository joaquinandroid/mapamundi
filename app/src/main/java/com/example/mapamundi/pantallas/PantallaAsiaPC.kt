...
import com.example.mapamundi.modelo.PantallaAsiaPCviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaAsiaPC(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar14() },
        bottomBar = { PersonalizarBottomBar14() },
        content = { padding ->
            ContenidoScaffold14(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold14(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaAsiaPCviewModel = viewModel(),
    contexto: Context
