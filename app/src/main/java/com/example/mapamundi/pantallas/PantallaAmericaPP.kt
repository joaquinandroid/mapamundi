...
import com.example.mapamundi.modelo.PantallaAmericaPPviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaAmericaPP(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar22() },
        bottomBar = { PersonalizarBottomBar22() },
        content = { padding ->
            ContenidoScaffold22(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold22(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaAmericaPPviewModel = viewModel(),
    contexto: Context
