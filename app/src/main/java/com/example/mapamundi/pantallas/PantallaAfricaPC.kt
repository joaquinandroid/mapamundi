...
import com.example.mapamundi.modelo.PantallaAfricaPCviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaAfricaPC(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar12() },
        bottomBar = { PersonalizarBottomBar12() },
        content = { padding ->
            ContenidoScaffold12(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold12(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaAfricaPCviewModel = viewModel(),
    contexto: Context
