...
import com.example.mapamundi.modelo.PantallaTodosPPviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaTodosPP(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar28() },
        bottomBar = { PersonalizarBottomBar28() },
        content = { padding ->
            ContenidoScaffold28(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold28(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaTodosPPviewModel = viewModel(),
    contexto: Context
