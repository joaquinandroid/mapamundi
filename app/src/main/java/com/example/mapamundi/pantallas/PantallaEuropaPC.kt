...
import com.example.mapamundi.modelo.PantallaEuropaPCviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaEuropaPC(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar8() },
        bottomBar = { PersonalizarBottomBar8() },
        content = { padding ->
            ContenidoScaffold8(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold8(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaEuropaPCviewModel = viewModel(),
    contexto: Context
