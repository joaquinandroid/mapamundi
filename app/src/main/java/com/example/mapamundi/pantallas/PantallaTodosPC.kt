...
import com.example.mapamundi.modelo.PantallaTodosPCviewModel
import com.example.mapamundi.navigation.NavPantallas


@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PantallaTodosPC(navController: NavController) {
    var situacion = LocalContext.current
    Scaffold(
        topBar = { PersonalizarTopBar18() },
        bottomBar = { PersonalizarBottomBar18() },
        content = { padding ->
            ContenidoScaffold18(padding, navController, contexto = situacion )
        }
    )
}

@Composable
fun ContenidoScaffold18(
    padding: PaddingValues,
    navController: NavController,
    europaViewModel: PantallaTodosPCviewModel = viewModel(),
    contexto: Context
